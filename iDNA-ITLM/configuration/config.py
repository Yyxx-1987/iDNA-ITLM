...
def get_train_config():
    ...
    # parse.add_argument('-learn-name', type=str, default='TextCNN', help='learn name')
    ...
    # model parameters
    parse.add_argument('-max-len', type=int, default=400, help='max length of input sequences')
    parse.add_argument('-num-layer', type=int, default=3, help='number of encoder blocks')  # 3
    # parse.add_argument('-num-layer', type=int, default=12, help='number of encoder blocks')  # 3
    parse.add_argument('-num-head', type=int, default=8, help='number of head in multi-head attention')  # 8
    parse.add_argument('-dim-embedding', type=int, default=448, help='residue embedding dimension')  # 64
    ...
    parse.add_argument('-k-mer', type=int, default=4, help='number of k(-mer) in multi-sccaled')
    ...
    # parse.add_argument('-cuda', type=bool, default=-1, help='if not use cuda')
